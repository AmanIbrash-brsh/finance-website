{
  ...
  "}": "",
  "/**\n * Generates markup for a Telegram message with an 'Add Expense' button.\n */": "",
  "export function getExpenseButtonMarkup() {": "",
  "  return `\n  <telegram>\n    <message>\n      Please enter the expense amount and description:\n      <button data-action=\"add_expense\">Add Expense</button>\n    </message>\n  </telegram>\n`;": "",
  "}": ""
}